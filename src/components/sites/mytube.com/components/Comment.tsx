        ...
        if(user) return (
                <div className="comment render-as-pixels">
                    ...
                    <div className="comment__content">
                        <h4 className="hoverable" data-link={`myface.com/user/${user.username}`} onClick={() => this.props.redirect ? this.props.redirect(`myface.com/user/${user.username}`) : ""}>{user.username}</h4>
